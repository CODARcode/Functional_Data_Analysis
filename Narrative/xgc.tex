...
\label{sec:xgc}
We report on our application to fusion
...
100, 200, 300, and 400, by taking the index time step and 15 more steps
...
utilizes MPI, LAPACK, and ADIOS library support. Our runs were done on
Oak Redge Leadership Computing Facility's (OLCF) Rhea, which is a 512
node commodity cluster with dual Intel® Xeon® E5-2650 @ 2.0 GHz giving
16 cores per node. Our runs are on 8 nodes (128 cores) and take
...
of 512 resulting plots of right singular vectors and scree plots, like
...
by time: $32\times 16$) and because we have stationarity over space
and over the short time period, there is a relationship between this
...
the right singular vectors from our SVD are the rightmost singular
